...
def pesel_date_of_birth(pesel: str) -> str:
    ...
    if len(pesel) != 11 or not pesel.isalnum():
        raise ValueError('Not a correct format of the pesel')
...
def main() -> None:
    try:
        ...
        print(pesel_date_of_birth('9801090968'))
        print(pesel_date_of_birth('98010909'))
        print(pesel_date_of_birth('98010909kkkk80'))
